...
#include "QRCodeGenerator/Classes/QrCode.hpp"
#include "QRCodeGenerator/Classes/QrCode.cpp"
#include "QRCodeGenerator/Classes/BitBuffer.hpp"
#include "QRCodeGenerator/Classes/BitBuffer.cpp"
#include "QRCodeGenerator/Classes/QrSegment.hpp"
#include "QRCodeGenerator/Classes/QrSegment.cpp"
...
UTexture2D * UYourTools::GenerateQRCodeImageSimple(FString code)
{
...
UTexture2D * UYourTools::GenerateQRCodeImage(FString code, int QRCodeVersion, int PixelNum, FColor Backcolor, FColor QRPixelColor)
{
	UTexture2D* MyTexture = NULL;
