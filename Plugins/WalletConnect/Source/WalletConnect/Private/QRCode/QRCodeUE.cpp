...
UTexture2D* UQRCodeUE::GenerateQRCodeImageSimple(FString code)
{
...
UTexture2D* UQRCodeUE::GenerateQRCodeImage(FString code, int QRCodeVersion, int PixelNum, FColor Backcolor, FColor QRPixelColor)
{
	UTexture2D* MyTexture = NULL;
